...
public interface PetitionCommentDAO {
	...
	List<PetitionCommentVO> getCommentsByUser(String userId);

	void insertAnswer(PetitionCommentVO comment);

	PetitionCommentVO selectAnswer(Long petitionId);

	PetitionCommentVO selectComent(Long commentId);
