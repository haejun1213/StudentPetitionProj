...
public class PetitionCommentServiceImpl implements PetitionCommentService{
	...
	public List<PetitionCommentVO> getCommentsByUser(String userId) throws Exception {
		return petitionCommentDAO.getCommentsByUser(userId);
	}

	@Override
	public void addAnswer(PetitionCommentVO comment) {
		petitionCommentDAO.insertAnswer(comment);
		
	}

	@Override
	public PetitionCommentVO getAnswerByPetitionId(Long petitionId) {
		return petitionCommentDAO.selectAnswer(petitionId);
	}

	@Override
	public PetitionCommentVO getComment(Long commentId) {
		return petitionCommentDAO.selectComent(commentId);
	}
