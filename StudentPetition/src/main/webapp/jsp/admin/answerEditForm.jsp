...
<body>
	...
	<section class="answer-write-section">
		<div class="container">
			<h1>답변 수정</h1>
			<form action="editAnswer.do" method="post">
				...
				<div class="form-group">
					...
					<textarea id="content" name="content" required placeholder="답변 내용을 입력하세요."
						rows="6" class="form-input">${answer.content}</textarea>
				</div>
				
				<div class="form-group" style="text-align: center;">
				<button type="reset" class="btn-submit-comment" onclick="history.back();">
					돌아가기</button>
					<button type="submit" class="btn-submit-comment">답변 수정</button>
				</div>
			</form>
		</div>
	</section>
